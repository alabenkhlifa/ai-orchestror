...
7. Ask one consequential user-owned question at a time when the request remains ambiguous. Explain the impact and recommend a default when one is justified.
